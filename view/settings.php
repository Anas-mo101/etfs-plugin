...
<div>
    ...
    <div class="ETF-Pre-form-input-contianer">
        <div class="ETF-Pre-form-sftp-contianer">
            <h3 style="margin: 10px 0 30px 0;">Premium/Discount Historical</h3>
            <div>
                <input type="file" id="pd-historical-file" accept=".csv">
                <button class="btn btn-primary btn-lg" id="pd-submit-button">Process File</button>
            </div>

            <br>

            <button class="btn btn-primary btn-lg" id="pd-sync-button">Sync Count</button>
        </div>
    </div>
