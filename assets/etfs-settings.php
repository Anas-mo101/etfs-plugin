...
$sftp_config = $sftp->get_config($_POST);
?>
<h1> ETFs Settings </h1>
<div>
    <div>
                ...
                <form class="ETF-Pre-form-sftp-contianer">
                    ...
                    <div>
                        <div class="ETF-Pre-input-toggle-text">
                            <h4>SFTP is <span id='ETF-Pre-toggle-state-text'> <?php echo ($sftp_config["Automate"] === "true") ? "on" : "off";?></span></h4>
                            <label class="switch">
                                <input <?php echo ($sftp_config["Automate"] === "true") ? "checked" : '' ; ?>id="ETFs-Pre-auto" type="checkbox" >
